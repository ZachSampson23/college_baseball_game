...
class Batter:
    def __init__(self, name, contact, power, speed, fielding, stars, potential, development_type, year):
        self.name = name
...
class Pitcher:
    def __init__(self, name, velocity, control, stuff, stars, potential, development_type, year):
        self.name = name
